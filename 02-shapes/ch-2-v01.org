...
The cultural critic Jean Baudrillard, in /The System of Objects/, observes the proliferation of objects in our world of mass production, arguing that "our urban civilization is witness to an ever-accelerating procession of generations of product, appliances and gadgets" [cite:@baudrillard2020system 3]. In the eighteenth century, he contends, these could be systematically catalogued in, for example, Diderot's /Encyclopédie/. But lately, "everyday objects ... proliferate, needs multiply, production speeds up the life-span of such objects—yet we lack the vocabulary to name them all" [cite:@baudrillard2020system 3].
...
Many of these are texts that have scored highly with the color imaginer of the previous chapter, and all of these were published squarely within the 1880–1930 period I am using as a proxy for literary modernism. Four, however, were published in 1922, specifically---"the year that changed literature" according to Goldstein, and "modernism year one," according to Jackson: both subtitles of monographs about the year's literary import [cite:@goldstein17;@jackson2013constellation].
...
Humbler guests poured each night from the termini into the overflowing city, and sought anxiously for some bed, lounge-chair, or pillowed corner, in which to rest until the morning. Stretched upon the table in a branch of the Y.W.C.A. lay a young woman from England whose clothes were of brand-new khaki, and whose name was Fanny. [cite:@bagnoldHappyForeigner1920]
#+END_QUOTE
...
There are neuroscientific factors which explain the distribution of body parts, however, which extend the work of these scholars of the literary body.
...
These proportions are remarkably similar to those which I find in British literature of the nineteenth and twentieth centuries, but with some notable differences. Lips and genitals, for instance, are granted much more attention by the brain than by literature, which suggests a cultural taboo against sexualized writing.

I argue that modernism's interest in the body, and modernity's, as well, may be attributed largely to this neurological map. What activates this interest, and its distribution outlined above, is the visuality of this period.
...
These findings extend the work of object and body theorists, in literary studies, and provide new pathways for exploration of these literary phenomena with the help of recent research in the neural and cognitive sciences.

In the next chapter, I will synthesize the findings of this chapter with those of Chapter 1, and show how these two aspects of vision, color and shape, converge in the image, the impression, and the literary description.
