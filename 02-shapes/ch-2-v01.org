...
# Maybe move final sentence to the top? 
...
# More about why this should matter later
# I'm going to use Freud in this way...
...
Friedrich Nietzsche, Marx's contemporary, takes this concept a step further, by explaining how objects are fetishized by our natural need for anthropomorphization. In his early early essay of 1873, "On Truth and Lie in a Nonmoral Sense," argues that objects, as we understand them, are products of "the metamorphosis of the world into man":
...
A very similar idea may be also found in the later philosopher Henri Bergson, whose /Creative Evolution/ was widely read by modernist writers: "the human intellect feels at home among inanimate objects," he writes, "more especially among solids, where our action finds its fulcrum and our industry its tools" [cite:@bergsonIntroductionMetaphysics1912 21]. In other words, the solidity of the object is what distinguishes it from matter.

William James, in a chapter of his 1890 /Principles of Psychology/ called "The Perception of Things," conducts a thought-experiment which highlights the telic/aesthetic dichotomy of thing theory. Looking at a landscape, or a painting, upside-down, he observes, causes the aesthetic experience of it to be richer:
...
I am not /merely/ arguing here that there is a genealogy of thought about objects which, threading through Frazer, Freud, Marx, Nietzsche, Bergson, and James, arrives in literary theory, and the literary theories of early 20th century writers. Rather, to oversimplify, one could say that things become objects, grammatically and phenomenologically, through a process of fetishization, which infuses the object with a social, sexual, and/or pragmatic function. That function is by necessity an anthropomorphization. The opposite function, in which the object becomes a thing, operates through a disillusionment with this anthropomorphization, and defamiliarizes the object.
...
#+INCLUDE: "02-shapes/includes/object_proportions.html" export html
...
#+INCLUDE: "02-shapes/includes/living_thing.n.01.html" export html

#+CAPTION: =living_thing.n.01= proportions over time, $C_{PG2}$
#+LABEL: fig:livingThing
[[./images/dummy.png]]

#+INCLUDE: "02-shapes/includes/natural_object.n.01.html" export html

#+CAPTION: =natural_object.n.01= proportions over time, $C_{PG2}$
#+LABEL: fig:naturalObject
[[./images/dummy.png]]

#+INCLUDE: "02-shapes/includes/artifact.n.01.html" export html
...
#+INCLUDE: "02-shapes/includes/bodyPartDiachronic.html" export html
...
#+INCLUDE: "02-shapes/includes/bodyPartSums.html" export html
...
#+INCLUDE: "02-shapes/includes/bodyPartSumsBody.html" export html
