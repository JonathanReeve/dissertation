...
(let
    ...
    ewiser = pkgs.python3Packages.buildPythonPackage rec {
      pname = "ewiser";
      version = "0.1";
      src = pkgs.fetchFromGitHub {
        rev = "431adb3e74461a991562ce1657008c9f57d5752c";
        repo = "ewiser";
        owner = "SapienzaNLP";
        sha256 = "Gzmn9gmppJy9gr6ac1BdTezO4P0dIZkzpjGUPqPwn6A=";
      };
      buildInputs = with pkgs.python3Packages; [ nltk numpy h5py
                                                 joblib fairseq
