...
* TODO Experimental Design: Modeling Imagination
  :PROPERTIES:
...
[fn:1] If an exact match for a hex value does not exist  in a color map, I find the closest color to it using $\Delta E^{*}_{ab}-76$. This is described in more detail in [cite:@secCategorization].
