...
| 1919 | Mary Oliver, a Life                     | Sinclair, May          | Autobiog. novel          | 0.004566 |
...
- Bildung, Impression, Distance, Ecstasy
...
#+begin_quote
Writers of diaries, notebooks, and memoirs have the advantage of making everything proceed from a certain instant: according to the moment, they can change writing styles, that is the manner of suggesting reality; they can change point of view in order to capture thee most volatile moments of life together with nuances of color and tone, and to seize in passing the variations in asspect which the same scene assumes at different moments; they can reveal the development of awareness of the protagonist. [cite:@kronegger1973literary 51]
#+end_quote

This changing point of view—perhaps more analagous to painterly cubism than to impressionism—is a style we see in Joyce's /Portrait/ and /Ulysses/, Woolf's /Mrs Dalloway/. Before all of those, however, there was Dorothy Richardson's /Pointed Roofs/, an examplar of literary impressionism, remarkable in its subjectivity and its sensory detail. It exhibits very high proportions of color expressions throughout.

J.D. Beresford, who writes the introduction to the first edition, doesn't quite know what to make of its point of view, at first. When he reads the novel in manuscript, he decides it "was realism, was objective" [cite:@richardson2014pointed 257]. The second time, however, when he reads the novel in typescript, he decides "it is the most subjective thing I have ever read." He imagines that "the writer of this has gone through life with eyes that looked inward; she has known every person and experience solely by her own sensations and reactions" [cite:@richardson2014pointed 258]. The third time he reads it, however, he is enlightened: he suspends his judgment about its objectivity or subjectivity entirely.

May Sinclair's introduction to it agrees with Beresford, and polimicizes this view. It reads almost like a manifesto for literary impressionism. Sinclair writes:
...
After quoting an exceptionally colorful passage from Richardson's /Honeycomb/, Sinclair declares: "it is as if no other writers had ever used their senses so purely and with so intense a joy in their use" [cite:@richardson_pointed_1919 xii].
...
This segment is notable, not because it uses traditionally-recognizable abstract color words, like /red/, /green/, /blue/, and so on, but because it is colorful for its imaginable nouns: /sand/ (#e2ca76), /earth/ (#a2653e), /forest/ (#0b5509), /ocean/ (#017b92), /sky/ (#82cafc), and /sea/ (#3c9992), for example.

It is no coincidence that Father Arnall repeats, three times, his instruction for his young listeners to /imagine/.

The next peak in colors comes at 60% of the novel, where an older Stephen, an aspiring poet, wonders what it is that attracts him to words. He reads one of his lines, "a day of dappled seaborne clouds," and all of a sudden, "the phrase and the day and the scene harmonized in a chord" [cite:joyce_portrait_2007 146]
. Stephen thinks:
