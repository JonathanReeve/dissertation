...
* Introduction
Having dealt with color vision in Chapter 1, and object vision in Chapter 2, we now turn to their aggregate: the image, in order to interrogate questions of literary historical trends raised by these previous chapters.
