...
To quantify bodies in literature, I use the same annotations provided by EWISER's WSD, but search for hyponyms of =body_part.n.01=. This largely filters out any use of body parts as metaphors, which could, in more naive analyses, have accounted for most of the instances of given words. For instance, /heart/ as center should not be considered synonymous with /heart/, the organ, just as /hand/, help, as in, to give one a hand, should not be considered the same as the body part. I then aggregate the results, and divide by the total number of words in a text.
...
| 1907 | Privy Seal, Hist Last Venture             | Ford Madox Ford          |     0.010192 |
...
Following that are three works by Joan Conquest, a largely forgotten novelist of the early 20th Century, writing in the genre of fantasy romance. Set in India and Egypt, these are novels which use their Eastern locales as means towards rich description, of bodies and setting.

Also present are two novels by Ford Madox Ford, /The Fifth Queen/ and /Privy Seal/.

Finally, there are two novels by Joseph Conrad, /Gaspar Ruiz/ and /The Nigger of the Narcissus/.

The texts with the least hyponyms of =body_part.n.01= is similar to that of other objects. After removing non-fiction works erroneously categorized here, the result is largely a list of Victorian romances. Jane Austen figures heavily here,
