...
First, however, some historical context is necessary. Trends in the intellectual climate of Britain, around the turn of the century, account for some of the period's treatment of objects, bodily or otherwise. Thus, to understand the rise of the object in literature, we should understand how objects were understood in the philosophies and sciences of the day.
...
And of course, /Ulysses/ is famous for some of its catalogs of artifacts. Told in the style of a Christian catechism, the "Ithaca" episode represents the height of this mode. Here, Leopold Bloom lists the things on his mantelpiece, all of which are wedding presents.
...
The human body is not only a special type of object, but in one sense, its archetype. The synonymy of /body/ with /object/, in its sense of /celestial bodies,/ hints at a lexical relation between the senses which extends beyond mere meronymy. In fact, this sense of /body/ is defined by the OED lexicographers as "a material thing, an object" [cite:@oed:body].
...
Simultaneously, fixation on body parts, with disregard for the holistic body, often carries with it connotation of sexual fixation. Binet's foundational work on sexual fetishism quoted above deals in particular with a taxonomy of pararphilias which he calls "1. l'amant de l'œil; 2. l'amant de la main; 3. l'amant des cheveux; 4. l'amant de l'odeur" [cite:@binet1887fétichisme 146]. The first three of these are body parts, as WordNet defines them.

# Freud: Interpretation of dreams: chest of drawers

Freud's psychology, which builds off of Binet, expands the fetishism of the body. His 1899 /Interpretation of Dreams/ relies heavily on lexical ambiguity to show how bodily anxieties of various kinds manifest themselves in dreams. In one case, one of Freud's patients asks her husband whether they should have the piano tuned, but concludes "it is not worth while" [cite:@freud1999interpretation 250]. She later calls the piano a "disgusting chest" and grasps at her jacket, which was missing a button. Freud explains that this means she is ashamed of her own chest (breasts), and thinks of her own chest "don't look, it is not worth while." The ambiguity in /chest/, then, both an artifact and a body part, is the fulcrum at which, for Freud, one's sexual embarrassments are encoded.
...
In modernist studies, the body has become an increasing axis of inquiry, as well as with objects.
...
To what extent does the literature of the early 20th century become corporeal? Do the bodies of literary characters become more legible, at the turn of the century, or less? How, precisely, do these bodies appear in fiction? What body parts are the foci of

To answer these questions, I turn again to word sense disambiguation, with EWISER and WordNet, but search for hyponyms of =body_part.n.01=. This largely filters out any use of body parts as metaphors, which could, in more naive analyses, have accounted for most of the instances of given words. For instance, /heart/ as center should not be considered synonymous with /heart/, the organ, just as /hand/, help, as in, to give one a hand, should not be considered the same as the body part. I then aggregate the results, and divide by the total number of words in a text.
...
The texts with the highest proportions of =body_part.n.01= hyponyms are shown in [cite:@tbl:bodyParts]. At the top of the list is the Victorian erotic novel /The Romance of Lust/, published anonymously, but rumored to have been written by William Simpson Potter and others of his coterie. Lisa Sigel describes it as "one of the most expensive pieces of Victorian pornography, costing upward of L10 in 1892, one of the longest at over 600 pages, and one of the best-known pieces of the period (running second place to /My Secret Life/ in all categories)" [cite:@sigel2006 1048].
...
Consider this physical character description of Elizabeth from /Pride and Prejudice/:
...
#+end_quote
[cite:@austen_pride_2013]

While there are some body parts present here, "face" and "eyes" are the only explicit ones, "form" and "figure" being more abstract bodily attributes. Where there is a description of Elizabeth's body, it is rather a means, a vehicle, for describing her "uncommonly intelligent" appearance. For Austen, the body is a mode of perceiving character and personality.

Compare this with a description of the titular character from Conrad's /Gaspar Ruiz/:
...
#+end_quote
[cite:@conradGasparRuiz]

Here, we learn of Gaspar's strong back, unblinking eyes, lips, oversized head, and chin. It is not Gaspar himself that looks, but "his eyes." And it is not Gaspar who speaks to this chapter's narrator, General Santierra, but "this head." As in "Solid Objects," where the two men first appear as "one small black spot," the visuality of bodily descriptions comes first. Unlike in Austen, where bodies are windows to personalities, in Conrad, the body eclipses even the self.
...
1. Objects in general are roughly 12% more common in fiction and poetry of the modern period.
...
6. The distribution of body objects, or body parts, in fiction largely follows that of the brain's sensory cortex.
