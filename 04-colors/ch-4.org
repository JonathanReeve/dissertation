...
Simon Dedalus substitutes "place" for what is in Thompson's song, "grave." The song's chorus reads: "'Oh! Lily, sweet Lily Dale, Now the wild rose blossoms  / O'er her little green grave, / 'Neath the trees in the flow'ry vale." [cite:gifford_joyce_1981 133]. This mistake is the first of many mistakes or parapraxes which will become hallmarks of Joyce's style. Young Stephen's refraction, "o, the geen wothe botheth," which makes the rose green, rather than the grave or place, appears several pages later, as an older Stephen muses in the classroom at Clongowes, where the class has been divided into white and red rose factions, an imitation of the English War of the Roses.
...
Green roses are of course possible with artificial coloring, and
 - Valente on
