...
Ryan Heuser and Long Le-Khac, of the Stanford Literary Lab, study changing levels of abstraction and concreteness in British novels; one of their metrics is color words. They find a "sharp rise" in color word proportions from 1785 to 1900, going from a 0.04% probability of color words in to 0.19%, more than a 290% increase [cite:@heuser_quantitative_2012 22]. 
 
Ted Underwood's recent /Distant Horizons: Digital Evidence and Literary Change/ begins with an analysis of a random sample of 347 volumes of fiction, and finds a very similar result as I do in [@fig:pubdateRegression] and [@fig:proportionsByDOB] below [cite:@underwood2019distant 10]. 

But these studies all use narrow definitions of the textual colors they measure. With the exception of Gladstone, whose manual tabulation allowed him to disambiguate senses, these studies typically measure color words according to their lexemes, undisambiguated by word senses. Think of the ambiguity between /rose/ the color, and /rose/ the past tense of the verb /to rise/. /Orange/ the fruit, and /gold/ the metal are similar examples. Heuser and Le-Khac's appendix, for instance, lists all 50 color words they use, among which are included /orange/ and /gold/ [cite:@heuser_quantitative_2012 55]. Underwood reveals that his list of color words "is long enough to include colors like 'cerulean,' but there will always be chromatic experiences it leaves out and emotions that it mistakes for a color when tallying up occurrences of a word like 'blue.'" [cite:@underwood2019distant 9]. 

The technique I develop below not only addresses these problems with word-counting, but better handles the problem of extracting visual information from text. In summary, it is an imagination machine: like a human reader, it is given textual input, and returns visual information: in this iteration, it is color and its distributions. Not only does it see the word /green/ and imagines TODO, or /avocado/ and imagines TODO, but is capable of imagining verbs, nouns, and abstract concepts, as well. This is all described in detail in [[#sec:experiment][the experiment section below]]. 
...
I arrive at the literary-historical trends in textual color, shown in [@fig:pubdateRegression] and [@fig:proportionsByDOB], through a complex process of modeling visual information. This process is not just a technical detail, but is coextensive with my argument:  
the wa


bears discussion, since it highlights many of the problems with chromatic description which modernism continually wrestles with.
...
* Results: what makes modernist literature colorful?
