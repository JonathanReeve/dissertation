...
#+RESULTS:
** Use new NER model to identify colors
...
: #+RESULTS:Python 3.7.6 (default, Dec 18 2019, 19:23:55) 
: [GCC 9.2.0] on linux
: Type "help", "copyright", "credits" or "license" for more information.
...
#+BEGIN_SRC python :results output :session session_init
lighthouse = open('../data/text/lighthouse-small.md').read()
#+END_SRC
...
#+RESULTS:
: (cloud, leaves, rain, rooks, brooms, secret, blue, red, secret, blue, brown, tobacco, sea, grey, mud, sea, sun, straw, seaweed, gritty, sand, blood, yellow, tobacco, grey, green, white, black, blues, go\, winter, blue, green, yellow, red, green, pink, green, grey, pink, tea, blue, buds, sun)
